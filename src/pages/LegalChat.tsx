...
const LegalChat = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      {/* Main Content Area with Spline and Chat */}
      <div className="flex-1 flex">
        {/* Spline 3D Scene */}
        <div className="w-1/2 bg-gradient-to-br from-blue-50 to-indigo-100">
          <div className="h-full flex items-center justify-center p-4">
            <div className="w-full h-full max-w-lg max-h-96 rounded-lg overflow-hidden shadow-lg">
              <Spline scene="https://prod.spline.design/kNVFLdI1tmHImKzL/scene.splinecode" />
            </div>
          </div>
        </div>
